...
int main()
{
	...
	m.nodes.push_back(Node(1,depends_on,dependents,printer1));
	...
	dep2.push_back(1);
	depn2.push_back(4);
	m.nodes.push_back(Node(2,dep2,depn2,printer2));
	...
	dep3.push_back(1);
	depn3.push_back(4);
	m.nodes.push_back(Node(3,dep3,depn3,printer3));
	...
	dep4.push_back(3);
	dep4.push_back(2);
	m.nodes.push_back(Node(4,dep4,depn4,printer4));
